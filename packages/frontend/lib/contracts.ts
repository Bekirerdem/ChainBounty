...
export const BOUNTY_EXECUTOR_ADDRESS = (process.env.NEXT_PUBLIC_BOUNTY_EXECUTOR_ADDRESS || "0x1878c4Cc35428C8d4A0A7Df4B67fc9aADd73b43a") as `0x${string}`;
